...
```
The `boilerplate-sdk` and `boilerplate-quickstart` directories contain the files that are used to create a new SDK or Quickstart.
### CHANGELOG.md
Will be generated by "Release Please" a SOC2 compliant versioning workflow.
### CODE_OF_CONDUCT.md
Links to the FusionAuth community guidelines. Please do not modify this file.
### CONTRIBUTING.md
Describes how to contribute to the project. Please do not modify this file.
### LICENSE
The Apache 2.0 license. Please do not modify this file.
### README.md
The README file for the project. This file should be modified to describe the project and how to run it.
### SECURITY.md
Links to the FusionAuth security guidelines. Please do not modify this file.
### docker-compose.yml
The docker-compose file for the project. This file should be modified to describe how to run the project.
### .github/ISSUE_TEMPLATE
The issue templates for the project. This file should be modified to describe how to run the project.
...
* It provides a set of APIs and libraries for interacting with FusionAuth
* It provides a set of tools for building applications with FusionAuth
* It provides a set of examples and documentation for building applications with FusionAuth
